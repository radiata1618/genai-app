...
export default function SprintPage() {
    ...
    return (
        <div className="w-full h-full flex flex-col overflow-hidden relative bg-slate-50/50">
            {/* Header Section */}
            <div className="flex-none bg-white/80 backdrop-blur border-b border-indigo-100 p-4 z-20">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <MobileMenuButton />
                        <div>
                            <div className="flex items-baseline gap-3">
                                <h1 className="text-2xl font-extrabold text-indigo-900 tracking-tight">{currentSprint.name}</h1>
                                <span className="text-xs font-medium text-indigo-400 px-2 py-0.5 bg-indigo-50 rounded-full border border-indigo-100">
                                    ACTIVE
                                </span>
                            </div>
                    ...
                    <div className="flex-1 max-w-2xl w-full mx-4">
                        <div className="relative group">
                            <textarea
                                ...
                                className="w-full bg-indigo-50/50 hover:bg-white focus:bg-white border-2 border-transparent focus:border-indigo-200 rounded-xl px-4 py-2 text-sm text-slate-700 placeholder-indigo-300 resize-none transition-all outline-none h-[60px]"
                            />
                    ...
                    <div className="flex items-center gap-2">
                        <label className="flex items-center gap-2 cursor-pointer bg-white px-3 py-2 rounded-lg border border-slate-200 text-xs font-bold text-slate-500 hover:text-indigo-600 transition-colors">
                            <input
                                type="checkbox"
                        ...
                        <button
                            ...
                            className="bg-white text-indigo-600 hover:bg-indigo-50 border border-indigo-200 px-4 py-2 rounded-lg text-sm font-bold shadow-sm transition-colors flex items-center gap-2"
                        >
                            <span>📎</span> Assign Tasks
                        </button>
                        <button
                            onClick={() => setShowCreateForm(!showCreateForm)}
                            className="bg-indigo-600 text-white hover:bg-indigo-700 hover:shadow-lg border border-transparent px-4 py-2 rounded-lg text-sm font-bold shadow-md transition-colors flex items-center gap-2"
                        >
                            <span>+</span> Create Task
                        </button>
                        <button
                            onClick={() => setShowRetroModal(true)}
                            className="bg-indigo-600 text-white hover:bg-indigo-700 px-4 py-2 rounded-lg text-sm font-bold shadow-md hover:shadow-lg transition-all"
                        >
                            Complete
                        </button>
                    </div>
